...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	 ...
	 * ;
	 * 
	 * auth.inMemoryAuthentication().withUser("deportista").password("pass").roles(
	 * "DEPORTISTA"); // Trainer
	 * auth.inMemoryAuthentication().withUser("entrenador").password("pass").roles(
	 * "ENTRENADOR"); // Admin //
	 * auth.inMemoryAuthentication().withUser("Admin").password("adminpass").roles(
